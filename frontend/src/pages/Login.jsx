...
const Login = () => {
    ...
    return (
        <form onSubmit={onSubmitHandler}>
            ...
            '>
                <h2 className='text-gray-600 font-semibold text-2xl'>Sign In</h2>
                <p className='text-gray-600 mt-3 mb-3 text-sm md:text-lg'>Please log in to book appointment</p>
                ...
                <div className='mt-5'>
                    ...
                    <p className='text-sm md:text-lg text-gray-600 mt-8'>Create a new account ?
